...
def draw_tracks(frame, tracks, class_names, colors, class_counters, track_class_mapping, last_save_time):
...
def main(_argv):
    try:
        ...
        while True:
            ...
            frame, last_save_time = draw_tracks(frame, tracks, class_names, colors, class_counters, track_class_mapping, last_save_time)
